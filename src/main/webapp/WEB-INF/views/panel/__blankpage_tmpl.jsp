            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-laptop"></i> <span>Layouts</span></a>
                    <ul class="sub-menu-list">
                        <li <%-- TODO active 位置 --%> class="active"><a href="blank_page.html"> Blank Page</a></li>
                ...
                <li><a href="login.jsp"><i class="fa fa-sign-in"></i> <span>重新登陆</span></a></li>
            </ul>
            <!--sidebar nav end-->
        </div>
    </div>
